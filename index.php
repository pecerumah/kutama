<?php
/* Required settings     */
$CLOAKING['WHITE_PAGE'] = 'https://adsmart.detik.com';//PHP/HTML file or URL used for bots
$CLOAKING['OFFER_PAGE'] = 'https://obatkuat-ampuhsekali99.blogspot.com';//PHP/HTML file or URL offer used for real users
